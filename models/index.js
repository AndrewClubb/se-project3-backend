...
db.course.hasMany(db.specialList, {as: 'specialList'}, {foreignKey:{allowNull:false }, onDelete:'CASCADE'});
db.specialList.belongsTo(db.user, {as: 'user'}, {foreignKey:{allowNull: false}, onDelete:'CASCADE'});
db.specialList.belongsTo(db.course, {as:'course'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
...
db.section.hasMany(db.sectionTime, {as:'sectionTime'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
...
db.faculty.hasMany(db.event, {as:'event'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
db.semester.hasMany(db.event, {as:'event'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
db.room.hasMany(db.event, {as:'event'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
db.event.belongsTo(db.faculty, {as:'faculty'}, {foreignKey:{allowNull: false}, onDelete:'CASCADE'});
...
db.section.hasMany(db.editedSection, {as:'editedSection'}, {foreignKey:{allowNull:false}, onDelete:'CASCADE'});
db.editedSection.belongsTo(db.section, {as:'section'}, {foreignKey:{allowNull: false}, onDelete:'CASCADE'});
